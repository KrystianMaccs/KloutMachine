...
class Profile(TimeStampedUUIDModel):
    ...
    license = models.CharField(
        verbose_name=_("Photography license"), max_length=20, blank=True, null=True
    )
    ...
    is_buyer = models.BooleanField(
        ...
        default=False,
        help_text=_("Are you looking to Buy a Photo?"),
    )
    is_seller = models.BooleanField(
        verbose_name=_("Seller"),
        default=False,
        help_text=_("Are you looking to sell a photo?"),
    )
